  ...
  return (
    <>
      <section className="bg-babyblue text-white py-20 rounded-t-3xl md:flex md:items-center md:pl-6 lg:pl-8 xl:pl-10">
        <div>
          <p className="text-2xl font-mulish font-semibold px-5 md:text-3xl lg:text-4xl">Contact us</p>
          <p className="p-5">
            Contact us if you need more information about our services
          </p>

          <form action="" className="grid space-y-4 px-5 font-inter md:h-60 md:space-y-3">
            <input
              type="text"
              id="name"
              placeholder="Name"
          ...
          <div className="grid m-5">
            <Button
              ...
              type="button"
              className="bg-white px-16 py-4 text-gray-600 rounded-xl font-semibold font-inter cursor-pointer shadow-md shadow-blue-800 hover:bg-inputblue hover:text-white md:px-6"
            />
          </div>
        </div>

        <div className="mt-10 md:overflow-x-hidden">
          <img src={Car} alt="" className="w-full md:h-[430px] lg:w-[800px] lg:ml-8 lg:h-[520px] xl:ml-14 xl:w-[1000px]" />
        </div>
      </section>
    </>
  );
